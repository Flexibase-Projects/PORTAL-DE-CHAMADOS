...
// Em desenvolvimento: usar /api para o proxy do Vite (5173 -> 3001)
// Em produção: backend serve o frontend, mesma origem /api
// Sobrescrever com VITE_API_URL no .env se precisar
